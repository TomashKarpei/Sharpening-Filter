...
public class filtr_prewitta2 {

 BufferedImage image;
 int width;
 int height;

 public filtr_prewitta2() {
 ...
 int[][] M = new int[][] { {1,0,-1}, {1,0,-1}, {1,0,-1}};
 ...
 File ouptut = new File("filtr_prewitta2.jpg");
 ...
 {
 filtr_prewitta2 obj = new filtr_prewitta2();
 }
}