...
public class filtr_sobela2 {

 BufferedImage image;
 int width;
 int height;

 public filtr_sobela2() {
 ...
 int[][] M = new int[][] { {1,0,-1}, {2,0,-2}, {1,0,-1}};
 ...
 File ouptut = new File("filtr_sobela2.jpg");
 ...
 {
 filtr_sobela2 obj = new filtr_sobela2();
 }
}