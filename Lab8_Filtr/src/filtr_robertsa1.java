...
public class filtr_robertsa1 {

 BufferedImage image;
 int width;
 int height;

 public filtr_robertsa1() {
 ...
 int[][] M = new int[][] { {0,0,0}, {0,1,-1}, {0,0,0}};
 ...
 File ouptut = new File("filtr_robertsa1.jpg");
 ...
 {
 filtr_robertsa1 obj = new filtr_robertsa1();
 }
}