...
public class filtr_laplacea1 {

 BufferedImage image;
 int width;
 int height;

 public filtr_laplacea1() {
 ...
 int[][] M = new int[][] { {0,-1,0}, {-1,4,-1}, {0,-1,0}};
 ...
 File ouptut = new File("filtr_laplacea1.jpg");
 ...
 {
 filtr_laplacea1 obj = new filtr_laplacea1();
 }
}