...
public class filtr_sobela1 {

 BufferedImage image;
 int width;
 int height;

 public filtr_sobela1() {
 ...
 int[][] M = new int[][] { {1,2,1}, {0,0,0}, {-1,2,-1}};
 ...
 File ouptut = new File("filtr_sobela1.jpg");
 ...
 {
 filtr_sobela1 obj = new filtr_sobela1();
 }
}